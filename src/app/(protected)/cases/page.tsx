  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <p className="text-sm text-slate-500">사건 관리</p>
          <h1 className="text-3xl font-bold text-slate-900">내 사건 목록</h1>
        </div>
      ...
      <div className="rounded-xl border border-slate-100 bg-slate-50 px-4 py-3 text-xs leading-relaxed text-slate-600">
        <p>
          ...
          <span className="font-medium text-slate-800">보완 안내</span>를 눌러{" "}
                ...
                <tr key={item.id}>
                  ...
                  <td className="px-4 py-3 text-sm">
                    {isSupplementHubCaseStatus(item.status) ? (
                      ...
                      <span className="text-slate-300" title="이 상태에서는 허브 링크 없음">
                        —
                      </span>
                    )}
                  </td>
