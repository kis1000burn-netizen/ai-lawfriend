...
import { getLitigationDocumentService } from "@/features/document-intelligence/document-extraction.service";
...
export async function GET(_: Request, context: RouteContext) {
  try {
    ...
    const result = await getLitigationDocumentService(currentUser, caseId, fileId);
    return ok(result);
  } catch (error) {
