...
import { getLitigationExtractedTextService } from "@/features/document-intelligence/document-extraction.service";
...
export async function GET(_: Request, context: RouteContext) {
  try {
    ...
    const result = await getLitigationExtractedTextService(
      currentUser,
      caseId,
      fileId,
    );
