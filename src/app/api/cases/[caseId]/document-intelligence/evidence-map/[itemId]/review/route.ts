...
import { reviewLitigationEvidenceMappingItemService } from "@/features/document-intelligence/evidence-mapping.service";
import { z } from "zod";
...
export async function POST(request: Request, context: RouteContext) {
  try {
    ...
    const result = await reviewLitigationEvidenceMappingItemService(
      currentUser,
      caseId,
      itemId,
      body,
