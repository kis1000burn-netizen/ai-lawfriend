...
import { editDocumentIntelligenceReviewItemService } from "@/features/document-intelligence/document-intelligence-review.service";
import { z } from "zod";
...
export async function POST(request: Request, context: RouteContext) {
  try {
    ...
    const result = await editDocumentIntelligenceReviewItemService(
      currentUser,
      caseId,
      itemId,
      body,
