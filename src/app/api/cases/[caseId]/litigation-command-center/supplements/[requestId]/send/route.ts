...
import { sendCommandCenterSupplementService } from "@/features/document-intelligence/litigation-command-center-actions.service";
import { z } from "zod";
...
export async function POST(_: Request, context: RouteContext) {
  try {
    ...
    const result = await sendCommandCenterSupplementService(
      currentUser,
      caseId,
      requestId,
    );
